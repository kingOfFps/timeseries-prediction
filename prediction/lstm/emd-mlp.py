...
def main():
    ...
    saveTestResult(yPredict,'EMD-MLP')
...
{'epoch': 20, 'units': 64, 'stepIn': 28, 'stepOut': 1, 'ration': 0.8}
RMSE: 4670.54	MAPE: 6.38	PCC : 0.93	R2  : 0.85	用时：38.3s
